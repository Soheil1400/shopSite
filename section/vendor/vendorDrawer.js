                            ...
                            {d.items.map(i => (
                                <Link href={i.link} key={i.id}>
                                    <MenuItemCustom sx={{
                                        margin: '5px 0',
                                        height: '5px',
                                        color: router.asPath === i.link ? Theme.palette.primary.main : '',
                                        borderLeft: router.asPath === i.link ? `4px solid ${Theme.palette.primary.main}` : ''
                                    }}>
                                        <Grid
                                            color={router.asPath === i.link ? Theme.palette.primary.main : Theme.palette.secondary.light}
                                            pl={1} mr={1} mt={0.6}>
                                            {i.icon}
                                        </Grid>
